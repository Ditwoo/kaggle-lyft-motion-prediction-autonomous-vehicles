...
exp_basename = "resnet34_frast_fulldata_confidence_25hist_seg_cnt"
...
#     dm.require("scenes/validate_chopped_100/validate.zarr")
# ).open()

# bs = 32

# valid_dataset = SegmentationAgentDataset(
...
test_dataset = SegmentationAgentDataset(
...
with tqdm(total=len(test_dataloader)) as progress:
    for batch in test_dataloader:
        ...
        preds, confidences, _ = model(inputs)
