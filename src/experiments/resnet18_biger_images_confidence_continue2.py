...
def get_loaders(train_batch_size=32, valid_batch_size=64):
    ...
    train_dataset = Subset(train_dataset, list(range(n_samples, n_samples * 2)))
...
def experiment(logdir, device) -> None:
    ...
    load_checkpoint("./logs/resnet18_bigerimages_continue/stage_0/best.pth", model)
...
def main() -> None:
    experiment_name = "resnet18_bigerimages_continue2"
