...
from src.datasets import RotationAgentDataset
...
def get_loaders(train_batch_size=32, valid_batch_size=64):
    ...
    train_dataset = RotationAgentDataset(cfg, train_zarr, rasterizer)
...
def main() -> None:
    experiment_name = "resnet18_bigerimages_continue4_rotations"
