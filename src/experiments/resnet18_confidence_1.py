...
def experiment(logdir, device) -> None:
    ...
    load_checkpoint("./logs/resnet18_confidence/stage_0/best.pth", model)
    ...
    with TensorboardLogger(tb_dir) as tb:
        ...
        train_loader, _ = get_loaders(train_batch_size=64, valid_batch_size=64)
...
def main() -> None:
    experiment_name = "resnet18_confidence_1"
