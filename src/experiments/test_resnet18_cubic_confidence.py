...
from src.models.resnets import resnet18_cubic
...
def train_fn(
    ...
    with tqdm(total=len(loader), desc="train", disable=not verbose) as progress:
        for idx, batch in enumerate(loader):
            images, targets, target_availabilities, squares = t2d(
                (
                    batch["image"],
            ...
            predictions, confidences = model(images, squares)
...
def main() -> None:
    experiment_name = "test_resnet18_cubic_confidence"
